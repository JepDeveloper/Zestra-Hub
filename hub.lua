...
loldiscord = {"dude this is so cool","use fear x - f34r","showcase this","watch this space","bruh","use magnius - rexi","fear x winning","make it trending on twitter","oops","if this isnt in your auto exec, i will find you","preparing for lift off","dababy car","underrated","sirmeme make a video on fear hub","you know how i be, i just poopin","this table is long dude","discord.gg/shlex","boost the server damn it","pog champ","imagine trying to crack fear hub"}
